...
func NewMetrics(reg prometheus.Registerer) *Metrics {
	...
	m.dockerEntries = prometheus.NewCounter(prometheus.CounterOpts{
		Namespace: "promtail",
		Name:      "dockerswarm_target_entries_total",
		Help:      "Total number of successful entries sent to the Docker Swarm target",
	})
	m.dockerErrors = prometheus.NewCounter(prometheus.CounterOpts{
		Namespace: "promtail",
		Name:      "dockerswarm_target_parsing_errors_total",
		Help:      "Total number of parsing errors while receiving Docker Swarm messages",
	})
